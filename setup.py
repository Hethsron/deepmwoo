...
setup(
    name = 'deepmwoo',
    version = '0.0.1',
    description = 'Facial Recognition Algorithm Using Deep Learning',
    url = 'https://github.com/Hethsron/deepmwoo',
    ...
    project_urls = {
        ...
        'Funding' : '',
        'Say Thanks !' : '',
        'Source' : 'https://github.com/Hethsron/deepmwoo',
        'Tracker' : 'https://github.com/Hethsron/deepmwoo/issues'
    },
